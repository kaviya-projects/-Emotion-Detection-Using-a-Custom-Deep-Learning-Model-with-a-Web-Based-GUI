...
model = load_model('D:\improved_emotion_recognition_model.h5')
...
# Add a gradient background for the entire frame
canvas = tk.Canvas(frame, width=800, height=600)
canvas.place(relx=0, rely=0)
gradient_image = tk.PhotoImage(width=800, height=600)
for i in range(600):
